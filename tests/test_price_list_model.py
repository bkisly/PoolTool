...
def test_price_list_model_to_json_correct():
    expected_json = [
        # Monday
    ...
    assert PriceListModel.to_json(pricing) == expected_json


def test_price_list_model_to_json_wrong_object():
    with pytest.raises(TypeError):
        PriceListModel.to_json(6)
